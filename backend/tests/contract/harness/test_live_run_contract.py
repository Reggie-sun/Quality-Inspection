...
def test_live_operator_and_runtime_identity_are_bound_across_resume(
    ...
    monkeypatch.setenv(
        ...
        runner.EXPECTED_LIVE_COMPOSE_PROJECT,
    )
    monkeypatch.setattr(
        runner,
        "_chrome_identity",
    ...
    expected_identity = _run()["live_identity"]
    assert runner._current_live_identity() == expected_identity
    ...
    identity = runner._current_live_identity(
        {
            ...
            "QI_P0_FRONTEND_BASE": "http://127.0.0.1:14173",
            "COMPOSE_PROJECT_NAME": runner.EXPECTED_LIVE_COMPOSE_PROJECT,
        }
    )
