...
export const zhCN = {
  ...
  workbench: {
    ...
    sipConfirmationProgress: (confirmed: number, total: number) =>
      `检验项 SIP 已确认 ${confirmed} / ${total}`,
    nextUnconfirmedSip: "处理下一条未确认 SIP",
  ...
  export: {
    ...
    action: "生成正式文件",
    notReviewed: "尚未审核",
    pendingSip: (count: number) => `还需确认 ${count} 条检验项 SIP`,
