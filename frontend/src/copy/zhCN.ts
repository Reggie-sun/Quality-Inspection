...
export const zhCN = {
  ...
  technicalRequirements: {
    ...
    excluded: "已排除",
    adjustMatch: "调整匹配",
    viewTarget: (rawText: string) => `查看匹配检验项：${rawText}`,
    confirmCurrentMatch: (count: number) => `确认当前匹配（${count} 项）`,
    confirmGlobal: "确认设为全局要求",
    matchTarget: (rawText: string) => `确认匹配此检验项：${rawText}`,
    setGlobal: "设为全局要求",
    exclude: "排除此要求",
  },
  inspection: {
