...
export const zhCN = {
  ...
  inspection: {
    ...
    sourceType: "原始来源",
    sourcePending: "待判定来源",
    visualSourcePending: "图形符号待确认",
    revisionSourcePending: "修订标记（非检验）待确认",
    visualTranscription: "图形转写",
  ...
  review: {
    ...
    mergePreview: {
      title: "合并预览",
      sources: "来源检验项",
      mergedRawText: "合并后的原始标注",
      explanation: "合并不是数值相加",
      back: "返回修改",
      cancel: "取消",
      confirm: (count: number) => `确认合并 ${count} 项`,
    },
    drawingSource: "图纸原文",
    parsedResult: "解析结果",
    rawText: "原始标注",
